...
Route::get('/api-vue/student', function() {
    return view('students.api.list');
});

Route::get('/api-vue/student/{id}/edit', function () {
    return view('students.api.edit');
});

Route::get('/api-vue/student/create', function () {
return view('students.api.create');
});

Route::get('/api-vue/mark', function() {
    return view('marks.api.list');
});

Route::get('/api-vue/mark/{id}/edit', function () {
    return view('marks.api.edit');
});

Route::get('/api-vue/mark/create', function () {
return view('marks.api.create');
});
