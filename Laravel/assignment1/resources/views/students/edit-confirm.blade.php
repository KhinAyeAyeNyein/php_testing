...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Student Edit Confirm') }}</div>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="roll_Number"
                                class="col-md-4 col-form-label text-md-right required">{{ __('Roll_Number') }}</label>

                            <div class="col-md-6">
                                <textarea id="roll_Number" type="text"
                                    class="form-control @error('roll_Number') is-invalid @enderror" name="roll_Number"
                                    autocomplete="roll_Number">{{ old('roll_Number') }}</textarea>
                                @error('roll_Number')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group row">
                            <label for="class"
                                class="col-md-4 col-form-label text-md-right required">{{ __('Class') }}</label>

                            <div class="col-md-6">
                                <textarea id="class" type="text"
                                    class="form-control @error('class') is-invalid @enderror" name="class"
                                    autocomplete="class">{{ old('class') }}</textarea>
                                @error('class')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
